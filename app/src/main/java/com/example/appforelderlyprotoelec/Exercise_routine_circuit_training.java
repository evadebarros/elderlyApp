...
public class Exercise_routine_circuit_training extends AppCompatActivity {
    View view,popupView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("10 minute Circuit training");
        infoButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                info.setText("Circuit training is known to alleviate body pains, muscle aches and joint stiffness by strengthening surrounding muscle tissue.\n\nExercises covered include: toe touches, lateral shoulder, shallow squat\n\nNo equipment required.");
